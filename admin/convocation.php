                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ref_perso">
                                    <?php
                                        if ($result = $mysqli -> query("SELECT * FROM personnel where disponible='oui'")) {
  
                                            while($row = $result->fetch_array(MYSQLI_ASSOC)){
                                                
                                                if($_GET['ref_perso']==$row['ref_perso']){
                                                    echo "<option value='".$row['ref_perso']."' selected >".$row['nomfr']." ".$row['prenomfr']."</option>";
                                                }else{
                                                    echo "<option value='".$row['ref_perso']."'>".$row['nomfr']." ".$row['prenomfr']."</option>";
                                                }
                                            }
                                        }
                                    ?>
            ...
            <table style="margin-top:30px">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    if ($result = $mysqli -> query("SELECT * 
                                                        ...
                                                        AND (r.ref_perso1='".$_GET['ref_perso']."'
                                                        or r.ref_perso2='".$_GET['ref_perso']."'
                                                        or r.ref_perso3='".$_GET['ref_perso']."'
                                                    )")) {
